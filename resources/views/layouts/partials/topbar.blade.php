            ...
            <div class="d-flex align-items-center gap-1">
                ...
                <div class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ Route::has('admin.second') ? route('admin.second', ['pages', 'profile']) : '#' }}">
                            <i
                                class="bx bx-user-circle text-muted fs-18 align-middle me-1"
                            ></i
                            ><span class="align-middle">Profile</span>
                        </a>
                        <a class="dropdown-item" href="{{ Route::has('admin.second') ? route('admin.second', ['apps', 'chat']) : '#' }}">
                            <i
                        ...
                        <a class="dropdown-item" href="{{ Route::has('admin.second') ? route('admin.second', ['pages', 'pricing']) : '#' }}">
                            <i
                                class="bx bx-wallet text-muted fs-18 align-middle me-1"
                            ></i
                            ><span class="align-middle">Pricing</span>
                        </a>
                        <a class="dropdown-item" href="{{ Route::has('admin.second') ? route('admin.second', ['pages', 'faqs']) : '#' }}">
                            <i
                                class="bx bx-help-circle text-muted fs-18 align-middle me-1"
                            ></i
                            ><span class="align-middle">Help</span>
                        </a>
                        <a class="dropdown-item" href="{{ Route::has('admin.second') ? route('admin.second', ['auth', 'lock-screen']) : '#' }}">
                            <i
                        ...
                        <a
                            ...
                            href="{{ Route::has('admin.second') ? route('admin.second', ['auth', 'login']) : '#' }}"
