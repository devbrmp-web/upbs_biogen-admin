...
<body>
    ...
    <div class="footer-validation page-break-avoid">
        ...
        <img class="qr-image" src="data:image/svg+xml;base64,{{ base64_encode(QrCode::size(70)->margin(0)->generate(route('orders.track.alias', $order->order_code))) }}" alt="QR Tracking">
