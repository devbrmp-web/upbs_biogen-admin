@extends('layouts.vertical', ['title' => 'Create Commodity', 'subTitle' => 'Management'])
...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3">New Commodity</h4>
                ...
                <form action="{{ route('admin.commodities.store') }}" method="POST" enctype="multipart/form-data" id="commodityImageForm">
                    @csrf
